            ...
            <div class="col-lg-12">
                <div class="res-control d-flex align-items-center justify-content-between">
                    <div class="section-title mb-0">
                        <span class="title-head builder-editable" builder-identity="1">Cursos</span>
                        <h2 class="title builder-editable" builder-identity="2">Cursos em destaque
                        </h2>
                    </div>
                    <span class="featured-course-all-button">
                        <a href="{{ route('courses') }}" class="eBtn gradient builder-editable" builder-identity="3">Ver todos os cursos</a>
                    </span>
                </div>
            </div>
        </div>
