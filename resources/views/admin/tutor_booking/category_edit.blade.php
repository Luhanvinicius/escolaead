    ...
    <div class="row">
        <div class="col-12">
            <div class="mb-3">
                ...
                <input type="text" name="name" value="{{ $category->name }}" class="form-control ol-form-control" id="category_name" placeholder="{{ get_phrase('Enter your subject category name') }}" aria-label="{{ get_phrase('Enter your unique subject category name') }}" required />
            </div>
