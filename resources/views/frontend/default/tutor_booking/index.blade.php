                        ...
                        <div class="tutor-bootcamp-card">
                            ...
                            <div>
                                <div class="d-flex gap-3 justify-content-between mb-3 flex-column flex-sm-row">
                                    <div>
                                        <div class="d-flex gap-2 mb-14px">
                                        ...
                                        <ul class="d-flex column-gap-3 row-gap-2 flex-wrap">
